...
pygame.display.set_caption("Movables Beta")
...
music = pygame.mixer.music.load('naruto.mp3')
...
man = player(200, 325, 64,64)
bullets = []
goblin = enemy(0,332.5,64,64,450)
shootloop = 0
run = True
while run:
    clock.tick(27)
    ...
    if keys[pygame.K_SPACE] and shootloop == 0:
        ...
        if len(bullets) < 5:
            bullets.append(projectile(round(man.x + man.width //2), round(man.y + man.height//2), 3, (255,255,0), facing))
        shootloop = 1
